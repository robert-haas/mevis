...
setup(
    ...
    description='Interactive metagraph visualizations with Python and HTML/CSS/JS for OpenCog.',
    long_description=load_long_description(PKG_DIR),
    url='https://robert-haas.github.io/mevis-docs/',
    ...
    entry_points={
        'console_scripts': [
            '{pkg}={pkg}._internal.cli:parse'.format(pkg=PKG_NAME),  # command line interface
        ],
    },
